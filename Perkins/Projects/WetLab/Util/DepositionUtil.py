...
def run(Seq,output_base, 
    ...
    pPlotUtil.\
        lazyLabel("Microliters for Deposition",
                  ...
                  frameon=True)
    pPlotUtil.savefig(fig,output_base + "SpacingPerDeposition.png")
    """
    ...
    pPlotUtil.savefig(fig,output_base + "DiffusionTimes.png")
    """
    ...
    pPlotUtil.savefig(fig,output_base + "Gyration.png")
