...
\begin{frame}{\only<7>{\textcolor{RedOrange}{\textit{\underline{Naïve}}} }Determining the Model and Making Predictions}
...
\begin{frame}{Example where FEATHER has trouble}
