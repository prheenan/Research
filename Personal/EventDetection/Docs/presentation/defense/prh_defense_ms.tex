...
\begin{column}{0.6\textwidth}
  ...
  \begin{tikzpicture}
    ...
    \begin{scope}[x={(image.south east)},y={(image.north west)}]
      \only<-1> \fill [white] (0.0,0.0) rectangle (1.0,0.7);%
      \only<-2> \fill [white] (0.0,0.0) rectangle (1.0,0.4);%
    ...
    \begin{scope}[x={(image.south east)},y={(image.north west)}]
      \only<4> \fill [white] (0.0,0.0) rectangle (1.0,0.76);%
      \only<4-5> \fill [white] (0.0,0.0) rectangle (1.0,0.53);%
      \only<4-6> \fill [white] (0.0,0.0) rectangle (1.0,0.3);%
