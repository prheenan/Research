...
% Your text here
  ...
  \begin{itemize}
    ...
    \only<5>{
    \item Next paper: unfolding \underline{and} refolding of protein\cite{yu_hidden_2017} 
    }
  \end{itemize}
  }
  \end{itemize}
...
\begin{column}{0.5\textwidth}
\begin{itemize}
 \item<2-> Spline difference
 \item<4-> Spline differentiation
 \item<5-> Spline residual integral
\end{itemize}
  \begin{overlayarea}{\textwidth}{\textheight}
  \begin{tikzpicture}
    \node<2-3>[anchor=south west,inner sep=0] (image) at (0,0) {\includegraphics[width=\textwidth]{explaining_spline0.pdf}};
    \node<4>[anchor=south west,inner sep=0] (image) at (0,0) {\includegraphics[width=\textwidth]{explaining_spline1.pdf}};
    \node<5>[anchor=south west,inner sep=0] (image) at (0,0) {\includegraphics[width=\textwidth]{explaining_spline2.pdf}};
    \node<6>[anchor=south west,inner sep=0] (image) at (0,0) {\includegraphics[width=\textwidth]{explaining_spline3.pdf}};
\end{tikzpicture}
  \end{overlayarea}
...
\begin{column}{0.5\textwidth}
  ...
  \begin{tikzpicture}
    ...
    \node<2-3>[anchor=south west,inner sep=0] (image) at (0,0) {\includegraphics[width=\textwidth]{algorithm_retract1.pdf}};
    \node<4>[anchor=south west,inner sep=0] (image) at (0,0) {\includegraphics[width=\textwidth]{algorithm_retract2.pdf}};
    \node<5-6>[anchor=south west,inner sep=0] (image) at (0,0) {\includegraphics[width=\textwidth]{algorithm_retract3.pdf}};
\end{tikzpicture}
\end{overlayarea}
\end{column}
