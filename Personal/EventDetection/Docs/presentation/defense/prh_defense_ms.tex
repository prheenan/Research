...
\begin{frame}{Metric 1: Bhattacharya Coefficient Complement (BCC)}
...
% Your text here
  \begin{itemize}
  \item
    BCC measures disagreement between distributions (X,Y)
    \begin{itemize}
    \item
      Mathematically: $1-\braket{X^{1/2}}{Y^{\frac{1}{2}}}$
    \item<2->
      Single attachment
    \item<3->
      Multiple attachments
