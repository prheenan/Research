...
% Your text here
  \begin{itemize}
  \item
    AFM tip approaches surface, pulls sample.
    \begin{itemize}
    \item
      No attachment
    \item<2->
    ...
    \end{itemize}
  \item<4->
    \textit{Ruptures} ($\textcolor{OliveGreen}{\blacktriangledown{}}$) denote tip-molecule unbinding
...
% and: tex.stackexchange.com/questions/82530/how-to-draw-a-filled-rectangle-without-a-border-using-tikz
    \node[anchor=south west,inner sep=0] (image) at (0,0) {\includegraphics[width=\textwidth]{cartoon.pdf}};
