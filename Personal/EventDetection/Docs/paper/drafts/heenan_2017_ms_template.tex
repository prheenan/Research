...
\firstp Smooth glass surfaces were prepared using 3M Potassium Hydroxide etching as follows. Glass disks of XXmm (YYY) were and sonicated (XXX) for 5 minutes in 95\% ethanol (YYY), ACS grade acetone (ZZZ), transferred to a 3M solution of Potassium Hydroxide (XXX) for 3 minutes. To removed residual KOH, the glass was serially diluted in two 1L beakers of deionized water, and the etched surfaces were dried with ultra-pure Nitrogen gas (XXX) and stored at room temperature. \pl
