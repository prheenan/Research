...
def check_bcc(examples,predicted,bcc_threshold=0.0445,
              rupture_tuple=(0.070,0.803)):
...
def run():
    ...
    threshold = 1e-3
    fractional_error_tolerance = 4.11e-3
    error_dist_tolerance = np.array([1.74e-4,3.30e-3])
    predicted,examples = [],[]
    max_error = 0
    error_dist = []
